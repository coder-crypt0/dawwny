...
- [ ] M1: validated edits and persistence, demo composition, MIDI import/export
- [ ] M2: real native synthesis, transport, effects, streaming WAV export
- [ ] M3: native arrangement, note editing, sound controls, mixer, save/load
- [ ] M4: local MCP tools editing the same session with revision checks
