...
**Status: foundation under active development.** This repository starts with the native workspace and shared project types. Playable synthesis, editing, export, and MCP integration follow in independently verified milestones. This is not yet a replacement for a mature production DAW.
